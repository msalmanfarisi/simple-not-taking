...
class NoteController extends Controller
{
    ...
    private function validatedPayload(Request $request): array
    {
        ...
        return $request->validate([
            ...
            'thumbnail' => ['nullable', 'image', 'mimes:jpg,jpeg,png', 'extensions:jpg,jpeg,png', 'max:8192'],
            'attachments' => ['nullable', 'array', 'max:20'],
            'attachments.*' => ['file', 'extensions:'.$allowed, 'mimes:'.$allowed, 'max:'.(FileSecurity::MAX_ATTACHMENT_BYTES / 1024)],
